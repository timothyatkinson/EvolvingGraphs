...
bool matcheggp_dc_fy_bucketEdge(Morphism *morphism)
{
   if(2 > eggp_dc_fy_host->number_of_nodes || 1 > eggp_dc_fy_host->number_of_edges) return false;
...
void applyeggp_dc_fy_bucketEdge(Morphism *morphism, bool record_changes)
{
   ...
   changeEdgeMark(eggp_dc_fy_host, host_edge_index, 1);
...
bool fillpoteggp_dc_fy_bucketEdge(MorphismPot *pot, Morphism *morphism)
{
   if(2 > eggp_dc_fy_host->number_of_nodes || 1 > eggp_dc_fy_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "eggp_dc_fy_bucketEdge", eggp_dc_fy_host);
