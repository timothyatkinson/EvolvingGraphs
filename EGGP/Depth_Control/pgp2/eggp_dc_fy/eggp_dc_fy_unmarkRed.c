...
bool matcheggp_dc_fy_unmarkRed(Morphism *morphism)
{
...
void applyeggp_dc_fy_unmarkRed(Morphism *morphism, bool record_changes)
{
...
bool fillpoteggp_dc_fy_unmarkRed(MorphismPot *pot, Morphism *morphism)
{
   if(1 > eggp_dc_fy_host->number_of_nodes || 0 > eggp_dc_fy_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_dc_fy_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "eggp_dc_fy_unmarkRed", eggp_dc_fy_host);
