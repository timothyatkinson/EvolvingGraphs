...
bool matcheggp_dc_fy_readdEdge(Morphism *morphism)
{
   if(3 > eggp_dc_fy_host->number_of_nodes || 1 > eggp_dc_fy_host->number_of_edges) return false;
...
void applyeggp_dc_fy_readdEdge(Morphism *morphism, bool record_changes)
{
   int var_2 = getIntegerValue(morphism, 2);
   int host_edge_index = lookupEdge(morphism, 0);
   HostLabel label_e0 = getEdgeLabel(eggp_dc_fy_host, host_edge_index);
   HostLabel label;
   ...
   else
   {
      ...
      relabelEdge(eggp_dc_fy_host, host_edge_index, label);
   }
...
bool fillpoteggp_dc_fy_readdEdge(MorphismPot *pot, Morphism *morphism)
{
   if(3 > eggp_dc_fy_host->number_of_nodes || 1 > eggp_dc_fy_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "eggp_dc_fy_readdEdge", eggp_dc_fy_host);
