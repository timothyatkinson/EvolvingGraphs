...
bool matcheggp_dc_fy_markOutputsRed(Morphism *morphism)
{
...
void applyeggp_dc_fy_markOutputsRed(Morphism *morphism, bool record_changes)
{
...
bool fillpoteggp_dc_fy_markOutputsRed(MorphismPot *pot, Morphism *morphism)
{
   if(2 > eggp_dc_fy_host->number_of_nodes || 1 > eggp_dc_fy_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "eggp_dc_fy_markOutputsRed", eggp_dc_fy_host);
