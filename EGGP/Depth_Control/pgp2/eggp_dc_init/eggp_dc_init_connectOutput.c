...
bool eggp_dc_init_b5 = true;
bool eggp_dc_init_b6 = true;

static bool evaluateCondition(void)
{
   return (eggp_dc_init_b5 && eggp_dc_init_b6);
}

static void evaluatePredicateeggp_dc_init_5(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) eggp_dc_init_b5 = true;
   else eggp_dc_init_b5 = false;
}

static void evaluatePredicateeggp_dc_init_6(Morphism *morphism)
{
   int n0 = lookupNode(morphism, 0);
   /* If the node is not yet matched by the morphism, return. */
   if(n0 == -1) return;

   if(getOutdegree(eggp_dc_init_host, n0) < 1) eggp_dc_init_b6 = true;
   else eggp_dc_init_b6 = false;
}

static bool match_n0(Morphism *morphism);
static bool match_n1(Morphism *morphism);

bool matcheggp_dc_init_connectOutput(Morphism *morphism)
{
   if(2 > eggp_dc_init_host->number_of_nodes || 0 > eggp_dc_init_host->number_of_edges) return false;
...
static bool match_n0(Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_dc_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         evaluatePredicateeggp_dc_init_6(morphism);
...
void applyeggp_dc_init_connectOutput(Morphism *morphism, bool record_changes)
{
   int host_edge_index;
   int source, target;
...
bool fillpoteggp_dc_init_connectOutput(MorphismPot *pot, Morphism *morphism)
{
   if(2 > eggp_dc_init_host->number_of_nodes || 0 > eggp_dc_init_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_dc_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "eggp_dc_init_connectOutput", eggp_dc_init_host);
