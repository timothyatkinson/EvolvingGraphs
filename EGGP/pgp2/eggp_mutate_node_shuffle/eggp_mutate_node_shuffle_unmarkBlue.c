...
bool matcheggp_mutate_node_shuffle_unmarkBlue(Morphism *morphism)
{
...
void applyeggp_mutate_node_shuffle_unmarkBlue(Morphism *morphism, bool record_changes)
{
   ...
   changeNodeMark(eggp_mutate_node_shuffle_host, host_node_index, 0);
...
bool fillpoteggp_mutate_node_shuffle_unmarkBlue(MorphismPot *pot, Morphism *morphism)
{
   if(1 > eggp_mutate_node_shuffle_host->number_of_nodes || 0 > eggp_mutate_node_shuffle_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_mutate_node_shuffle_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "eggp_mutate_node_shuffle_unmarkBlue", eggp_mutate_node_shuffle_host);
