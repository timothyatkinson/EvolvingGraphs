...
bool matcheggp_mutate_node_shuffle_resetArityCounter(Morphism *morphism)
{
...
void applyeggp_mutate_node_shuffle_resetArityCounter(Morphism *morphism, bool record_changes)
{
...
bool fillpoteggp_mutate_node_shuffle_resetArityCounter(MorphismPot *pot, Morphism *morphism)
{
   if(1 > eggp_mutate_node_shuffle_host->number_of_nodes || 0 > eggp_mutate_node_shuffle_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(nodes = getRootNodeList(eggp_mutate_node_shuffle_host); nodes != NULL; nodes = nodes->next)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "eggp_mutate_node_shuffle_resetArityCounter", eggp_mutate_node_shuffle_host);
