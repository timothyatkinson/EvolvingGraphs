...
bool matcheggp_mutate_node_shuffle_readdEdge(Morphism *morphism)
{
   if(3 > eggp_mutate_node_shuffle_host->number_of_nodes || 1 > eggp_mutate_node_shuffle_host->number_of_edges) return false;
...
void applyeggp_mutate_node_shuffle_readdEdge(Morphism *morphism, bool record_changes)
{
   int var_2 = getIntegerValue(morphism, 2);
   int host_edge_index = lookupEdge(morphism, 0);
   HostLabel label_e0 = getEdgeLabel(eggp_mutate_node_shuffle_host, host_edge_index);
   HostLabel label;
   ...
   else
   {
      ...
      relabelEdge(eggp_mutate_node_shuffle_host, host_edge_index, label);
   }
...
bool fillpoteggp_mutate_node_shuffle_readdEdge(MorphismPot *pot, Morphism *morphism)
{
   if(3 > eggp_mutate_node_shuffle_host->number_of_nodes || 1 > eggp_mutate_node_shuffle_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "eggp_mutate_node_shuffle_readdEdge", eggp_mutate_node_shuffle_host);
