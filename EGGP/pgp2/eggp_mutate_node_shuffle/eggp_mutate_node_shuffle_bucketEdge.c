...
bool matcheggp_mutate_node_shuffle_bucketEdge(Morphism *morphism)
{
...
void applyeggp_mutate_node_shuffle_bucketEdge(Morphism *morphism, bool record_changes)
{
   ...
   changeEdgeMark(eggp_mutate_node_shuffle_host, host_edge_index, 1);
...
bool fillpoteggp_mutate_node_shuffle_bucketEdge(MorphismPot *pot, Morphism *morphism)
{
   if(2 > eggp_mutate_node_shuffle_host->number_of_nodes || 1 > eggp_mutate_node_shuffle_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "eggp_mutate_node_shuffle_bucketEdge", eggp_mutate_node_shuffle_host);
