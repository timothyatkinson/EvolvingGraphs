...
bool eggp_na_init_b3 = true;
bool eggp_na_init_b4 = true;

static bool evaluateCondition(void)
{
   return (eggp_na_init_b3 && eggp_na_init_b4);
}

static void evaluatePredicateeggp_na_init_3(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) eggp_na_init_b3 = true;
   else eggp_na_init_b3 = false;
}

static void evaluatePredicateeggp_na_init_4(Morphism *morphism)
{
   int n0 = lookupNode(morphism, 0);
   /* If the node is not yet matched by the morphism, return. */
   if(n0 == -1) return;

   if(getOutdegree(eggp_na_init_host, n0) < 1) eggp_na_init_b4 = true;
   else eggp_na_init_b4 = false;
}

static bool match_n0(Morphism *morphism);
static bool match_n1(Morphism *morphism);

bool matcheggp_na_init_connectOutput(Morphism *morphism)
{
   if(2 > eggp_na_init_host->number_of_nodes || 0 > eggp_na_init_host->number_of_edges) return false;
...
static bool match_n0(Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_na_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         evaluatePredicateeggp_na_init_4(morphism);
...
void applyeggp_na_init_connectOutput(Morphism *morphism, bool record_changes)
{
   int host_edge_index;
   int source, target;
...
bool fillpoteggp_na_init_connectOutput(MorphismPot *pot, Morphism *morphism)
{
   if(2 > eggp_na_init_host->number_of_nodes || 0 > eggp_na_init_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < eggp_na_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "eggp_na_init_connectOutput", eggp_na_init_host);
