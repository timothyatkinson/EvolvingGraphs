...
void applya_edge_pickEdge(Morphism *morphism, bool record_changes)
{
   ...
   HostLabel label_e0 = getEdgeLabel(a_edge_host, host_edge_index);
   if(record_changes) pushRemarkedEdge(host_edge_index, label_e0.mark);
   changeEdgeMark(a_edge_host, host_edge_index, 2);
   ...
   changeNodeMark(a_edge_host, host_node_index, 3);
   ...
   changeNodeMark(a_edge_host, host_node_index, 2);
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "a_edge_pickEdge", a_edge_host);
