...
bool tiny_gp_init_b5 = true;

static bool evaluateCondition(void)
{
   return (tiny_gp_init_b5);
}

static void evaluatePredicatetiny_gp_init_5(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) tiny_gp_init_b5 = true;
   else tiny_gp_init_b5 = false;
}

static bool match_n0(Morphism *morphism);

bool matchtiny_gp_init_removeDepth(Morphism *morphism)
{
   if(1 > tiny_gp_init_host->number_of_nodes || 0 > tiny_gp_init_host->number_of_edges) return false;
...
void applytiny_gp_init_removeDepth(Morphism *morphism, bool record_changes)
{
   string var_0 = getStringValue(morphism, 0);
   Assignment var_1 = getAssignment(morphism, 1);
   int host_node_index = lookupNode(morphism, 0);
   HostLabel label_n0 = getNodeLabel(tiny_gp_init_host, host_node_index);
   HostLabel label;
   int list_var_length0 = 0;
   ...
   else
   {
      ...
      relabelNode(tiny_gp_init_host, host_node_index, label);
   }
   /* Reset the morphism. */
   initialiseMorphism(morphism, tiny_gp_init_host);
}
...
bool fillpottiny_gp_init_removeDepth(MorphismPot *pot, Morphism *morphism)
{
   if(1 > tiny_gp_init_host->number_of_nodes || 0 > tiny_gp_init_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < tiny_gp_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "tiny_gp_init_removeDepth", tiny_gp_init_host);
