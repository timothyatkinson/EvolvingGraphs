...
bool matchtiny_gp_init_unmark(Morphism *morphism)
{
...
void applytiny_gp_init_unmark(Morphism *morphism, bool record_changes)
{
   ...
   changeNodeMark(tiny_gp_init_host, host_node_index, 0);
...
bool fillpottiny_gp_init_unmark(MorphismPot *pot, Morphism *morphism)
{
   if(1 > tiny_gp_init_host->number_of_nodes || 0 > tiny_gp_init_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < tiny_gp_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "tiny_gp_init_unmark", tiny_gp_init_host);
