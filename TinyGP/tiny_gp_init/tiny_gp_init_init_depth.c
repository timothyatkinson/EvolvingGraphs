...
bool matchtiny_gp_init_init_depth(Morphism *morphism)
{
...
void applytiny_gp_init_init_depth(Morphism *morphism, bool record_changes)
{
   ...
   Node *node0 = getNode(tiny_gp_init_host, host_node_index);
   if(!node0->root)
   {
...
bool fillpottiny_gp_init_init_depth(MorphismPot *pot, Morphism *morphism)
{
   if(1 > tiny_gp_init_host->number_of_nodes || 0 > tiny_gp_init_host->number_of_edges) return false;
...
static bool fillpot_n0(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < tiny_gp_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "tiny_gp_init_init_depth", tiny_gp_init_host);
