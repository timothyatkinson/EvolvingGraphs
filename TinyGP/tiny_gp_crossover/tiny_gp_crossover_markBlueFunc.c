...
bool tiny_gp_crossover_b1 = true;

static bool evaluateCondition(void)
{
   return (tiny_gp_crossover_b1);
}

static void evaluatePredicatetiny_gp_crossover_1(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) tiny_gp_crossover_b1 = true;
   else tiny_gp_crossover_b1 = false;
}
...
bool matchtiny_gp_crossover_markBlueFunc(Morphism *morphism)
{
...
static bool match_n1(Morphism *morphism, Edge *host_edge)
{
   ...
   do
   {
      ...
      if(result >= 0)
      {
         ...
         evaluatePredicatetiny_gp_crossover_1(morphism);
         if(!evaluateCondition())
         {
            /* Reset the boolean variables in the predicates of this variable. */
            tiny_gp_crossover_b1 = true;
            break;
         }
      }
      else break;
...
void applytiny_gp_crossover_markBlueFunc(Morphism *morphism, bool record_changes)
{
   ...
   changeNodeMark(tiny_gp_crossover_host, host_node_index, 3);
...
bool fillpottiny_gp_crossover_markBlueFunc(MorphismPot *pot, Morphism *morphism)
{
   if(2 > tiny_gp_crossover_host->number_of_nodes || 1 > tiny_gp_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "tiny_gp_crossover_markBlueFunc", tiny_gp_crossover_host);
