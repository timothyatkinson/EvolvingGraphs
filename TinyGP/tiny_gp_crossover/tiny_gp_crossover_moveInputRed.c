...
bool matchtiny_gp_crossover_moveInputRed(Morphism *morphism)
{
...
void applytiny_gp_crossover_moveInputRed(Morphism *morphism, bool record_changes)
{
...
bool fillpottiny_gp_crossover_moveInputRed(MorphismPot *pot, Morphism *morphism)
{
   if(3 > tiny_gp_crossover_host->number_of_nodes || 1 > tiny_gp_crossover_host->number_of_edges) return false;
...
static bool fillpot_n2(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < tiny_gp_crossover_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "tiny_gp_crossover_moveInputRed", tiny_gp_crossover_host);
