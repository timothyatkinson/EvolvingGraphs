...
bool matchtiny_gp_crossover_markBlueEdge(Morphism *morphism)
{
...
void applytiny_gp_crossover_markBlueEdge(Morphism *morphism, bool record_changes)
{
   int host_edge_index = lookupEdge(morphism, 0);
   HostLabel label_e0 = getEdgeLabel(tiny_gp_crossover_host, host_edge_index);
   if(record_changes) pushRemarkedEdge(host_edge_index, label_e0.mark);
   changeEdgeMark(tiny_gp_crossover_host, host_edge_index, 3);
...
bool fillpottiny_gp_crossover_markBlueEdge(MorphismPot *pot, Morphism *morphism)
{
   if(2 > tiny_gp_crossover_host->number_of_nodes || 1 > tiny_gp_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "tiny_gp_crossover_markBlueEdge", tiny_gp_crossover_host);
