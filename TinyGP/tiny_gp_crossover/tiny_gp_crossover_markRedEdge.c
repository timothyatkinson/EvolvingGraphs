...
bool matchtiny_gp_crossover_markRedEdge(Morphism *morphism)
{
...
void applytiny_gp_crossover_markRedEdge(Morphism *morphism, bool record_changes)
{
   ...
   changeEdgeMark(tiny_gp_crossover_host, host_edge_index, 1);
...
bool fillpottiny_gp_crossover_markRedEdge(MorphismPot *pot, Morphism *morphism)
{
   if(2 > tiny_gp_crossover_host->number_of_nodes || 1 > tiny_gp_crossover_host->number_of_edges) return false;
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism, Edge *host_edge)
{
   ...
   if(match)
   {
      ...
      host_node->matched = true;
      /* All items matched! */
         putMorphism(pot, morphism, "tiny_gp_crossover_markRedEdge", tiny_gp_crossover_host);
