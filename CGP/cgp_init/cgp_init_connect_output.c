...
bool cgp_init_b4 = true;
bool cgp_init_b5 = true;

static bool evaluateCondition(void)
{
   return (cgp_init_b4 && cgp_init_b5);
}

static void evaluatePredicatecgp_init_4(Morphism *morphism)
{
   ...
   if(!equalHostLists(array0, array1, list_length0, list_length1)) cgp_init_b4 = true;
   else cgp_init_b4 = false;
}

static void evaluatePredicatecgp_init_5(Morphism *morphism)
{
   int n0 = lookupNode(morphism, 0);
   /* If the node is not yet matched by the morphism, return. */
   if(n0 == -1) return;

   if(getOutdegree(cgp_init_host, n0) == 0) cgp_init_b5 = true;
   else cgp_init_b5 = false;
}
...
static bool match_n0(Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < cgp_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         evaluatePredicatecgp_init_5(morphism);
   ...
   for(host_index = 0; host_index < cgp_init_host->nodes.size; host_index++)
   {
      ...
      do
      {
         ...
         if(result >= 0)
         {
            ...
            evaluatePredicatecgp_init_4(morphism);
...
static bool fillpot_n1(MorphismPot *pot, Morphism *morphism)
{
   ...
   for(host_index = 0; host_index < cgp_init_host->nodes.size; host_index++)
   {
      ...
      if(match)
      {
         ...
         host_node->matched = true;
         /* All items matched! */
            putMorphism(pot, morphism, "cgp_init_connect_output", cgp_init_host);
